...
def main():
    ...
    print(f"{num_questions} questions yet to be generated, sampling GT captions from {gt_captions_folder_path}.")
    
    for i in range(num_questions):
        random_gt_file = random.choice(gt_captions_files)
        while random_gt_file in prompt_save_folder:
            random_gt_file = random.choice(gt_captions_files)# if the same gt caption was already used in a previous run of this script, random sample again
