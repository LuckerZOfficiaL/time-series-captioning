...
def batch_inference(model, image_paths, prompts, tokenizer=None, ts_emb=None, max_output_tokens=256):
    ...
    if tokenizer is None:
        ...
        responses = model.batch_chat(
            tokenizer=tokenizer, pixel_values=pixel_values, ts_emb=ts_emb, num_patches_list=num_patches_list, questions=prompts, generation_config={'max_new_tokens': max_output_tokens, 'do_sample': True}
        )
    return responses
